...
export class TextEditor extends BaseCustomWebComponentConstructorAppend {
    ...
    static initMonacoEditor() {
        ...
        return TextEditor._initPromise;
    }
    ...
    async ready() {
        ...
        await TextEditor.initMonacoEditor();
...
customElements.define('node-projects-text-editor', TextEditor);